...
<script lang="ts">
	...
	const calendarTranslations: {
		...
		pt: {
			...
			'calendar.modal.placeholderDescricao': 'Ex: Reunião com a equipa',
			'calendar.modal.salvar': 'Guardar Lembrete',
			'calendar.modal.cancelar': 'Cancelar',
			'calendar.modal.fechar': 'Fechar',
			'calendar.modal.excluirLembreteAria': 'Eliminar o lembrete',
